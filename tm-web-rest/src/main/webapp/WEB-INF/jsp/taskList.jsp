...
<html lang="en">
    <body>
        ...
        <form action="${pageContext.request.contextPath}/client/task/getTasksById" method="get">
        ...
        <form action="${pageContext.request.contextPath}/client/task/getTaskById" method="get">
            <label path="Id">TaskId:</label><input type="text" name="id" pattern="^[0-9]+$" title="Minimum 1 number" required/><br>
                    ...
                    <c:forEach items="${tasks}" var="task">
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${task.taskState == true}">
                                        <form action="${pageContext.request.contextPath}/client/task/updateTask" method="post">
                            ...
                            <td>
                                <form action="${pageContext.request.contextPath}/client/task/deleteTask" method="post">
                                    <input type="text" id="id" name="id" value="${task.taskId}" hidden="true"/>
