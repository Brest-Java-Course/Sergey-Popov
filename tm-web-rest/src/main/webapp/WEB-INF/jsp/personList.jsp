...
<html lang="en">
    ...
    <body>
        ...
        <a href='<spring:url value="/client/person/addPerson" />'><spring:message code="person.create" /></a>
        ...
        <form action="${pageContext.request.contextPath}/client/person/getPersonById" method="get">
        ...
        <form action="${pageContext.request.contextPath}/client/person/getPersonsWithTasksBetweenDate" method="get">
                ...
                <table>
                    ...
                    <c:forEach items="${persons}" var="person">
                        <tr>
                            ...
                            <td>
                                <form action="${pageContext.request.contextPath}/client/person/updatePerson" method="get">
                            ...
                            <td>
                                <form action="${pageContext.request.contextPath}/client/person/deletePerson" method="post">
                                    <input type="text" id="id" name="id" value="${person.personId}" hidden="true"/>
                                    <input type="submit" value="remove"/>
                                </form>
                            </td>
                            <td>
                                <form action="${pageContext.request.contextPath}/client/task/addTask" method="get">
