...
public class PersonDaoImpl implements PersonDao {
    ...
    public List<Report> getPersonsWithTasksBetweenDate(DateTime startDate, DateTime endDate) {
        ...
        Query query = emf.createQuery(
                "SELECT p.personId, p.personFirstName, p.personLastName, SUM(t.elapsedTime) as Quantity " +
                        "FROM Person p " +
        ...
        LOGGER.debug("PersonDaoImpl.getPersonsWithTasksBetweenDate() : personsList.size = {}", persons.size());
        ...
        for (Object[] object : persons) {
            ...
            report.setTimeTotal((Long)object[3]);
            reportList.add(report);
        }

        LOGGER.debug("PersonDaoImpl.getPersonsWithTasksBetweenDate() : reportList.size = {}", reportList.size());
