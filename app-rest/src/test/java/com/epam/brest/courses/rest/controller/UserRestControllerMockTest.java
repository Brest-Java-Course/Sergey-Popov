...
/**
 * Created by beast on 5.11.14. At 12.32
 */
...
public class UserRestControllerMockTest {
    ...
    public void setUp() {
        ...
        this.mockMvc = standaloneSetup(userRestController).setMessageConverters(new MappingJackson2HttpMessageConverter()).build();
